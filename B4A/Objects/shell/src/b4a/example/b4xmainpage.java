...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"audioPanel",_ref.getField(false, "_audiopanel"),"backPanel",_ref.getField(false, "_backpanel"),"donatePanel",_ref.getField(false, "_donatepanel"),"faceView",_ref.getField(false, "_faceview"),"instaView",_ref.getField(false, "_instaview"),"iyView",_ref.getField(false, "_iyview"),"iYWebView",_ref.getField(false, "_iywebview"),"LayoutHome",_ref.getField(false, "_layouthome"),"merchPanel",_ref.getField(false, "_merchpanel"),"recordPanel",_ref.getField(false, "_recordpanel"),"Root",_ref.getField(false, "_root"),"testPanel",_ref.getField(false, "_testpanel"),"videoPanel",_ref.getField(false, "_videopanel"),"webBackButton",_ref.getField(false, "_webbackbutton"),"WebView1",_ref.getField(false, "_webview1"),"xui",_ref.getField(false, "_xui"),"ytubeView",_ref.getField(false, "_ytubeview")};
}
}