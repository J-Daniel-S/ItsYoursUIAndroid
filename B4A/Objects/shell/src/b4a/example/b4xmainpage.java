...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"aTestPanel",_ref.getField(false, "_atestpanel"),"audioPanel",_ref.getField(false, "_audiopanel"),"donatePanel",_ref.getField(false, "_donatepanel"),"iyView",_ref.getField(false, "_iyview"),"Label1",_ref.getField(false, "_label1"),"LayoutHome",_ref.getField(false, "_layouthome"),"merchPanel",_ref.getField(false, "_merchpanel"),"recordPanel",_ref.getField(false, "_recordpanel"),"Root",_ref.getField(false, "_root"),"videoPanel",_ref.getField(false, "_videopanel"),"vTestPanel",_ref.getField(false, "_vtestpanel"),"WebView1",_ref.getField(false, "_webview1"),"xui",_ref.getField(false, "_xui")};
}
}