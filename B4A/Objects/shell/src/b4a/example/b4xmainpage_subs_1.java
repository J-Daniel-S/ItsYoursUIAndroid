...
Debug.ShouldStop(16);
 BA.debugLineNum = 70;BA.debugLine="Root.LoadLayout(\"WebView\")";
Debug.ShouldStop(32);
__ref.getField(false,"_root" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("WebView")),__ref.getField(false, "ba"));
...
b4xmainpage._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",b4xmainpage._xui);
 //BA.debugLineNum = 12;BA.debugLine="Private WebView1 As B4XView";
...
b4xmainpage._videopanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_videopanel",b4xmainpage._videopanel);
 //BA.debugLineNum = 16;BA.debugLine="Private aTestPanel As Panel";
b4xmainpage._atestpanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_atestpanel",b4xmainpage._atestpanel);
 //BA.debugLineNum = 17;BA.debugLine="Private vTestPanel As Panel";
b4xmainpage._vtestpanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_vtestpanel",b4xmainpage._vtestpanel);
 //BA.debugLineNum = 18;BA.debugLine="Private donatePanel As Panel";
b4xmainpage._donatepanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_donatepanel",b4xmainpage._donatepanel);
 //BA.debugLineNum = 19;BA.debugLine="Private merchPanel As Panel";
b4xmainpage._merchpanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_merchpanel",b4xmainpage._merchpanel);
 //BA.debugLineNum = 20;BA.debugLine="Private iyView As ImageView";
b4xmainpage._iyview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_iyview",b4xmainpage._iyview);
 //BA.debugLineNum = 21;BA.debugLine="Private LayoutHome As String";
b4xmainpage._layouthome = RemoteObject.createImmutable("");__ref.setField("_layouthome",b4xmainpage._layouthome);
 //BA.debugLineNum = 22;BA.debugLine="Private iYWebView As ImageView";
b4xmainpage._iywebview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_iywebview",b4xmainpage._iywebview);
 //BA.debugLineNum = 23;BA.debugLine="Private webBackButton As Label";
b4xmainpage._webbackbutton = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_webbackbutton",b4xmainpage._webbackbutton);
 //BA.debugLineNum = 24;BA.debugLine="Private ytubeView As ImageView";
b4xmainpage._ytubeview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_ytubeview",b4xmainpage._ytubeview);
 //BA.debugLineNum = 25;BA.debugLine="Private faceView As ImageView";
b4xmainpage._faceview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_faceview",b4xmainpage._faceview);
 //BA.debugLineNum = 26;BA.debugLine="Private instaView As ImageView";
...
try {
		Debug.PushSubsStack("donatePanel_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,79);
if (RapidSub.canDelegate("donatepanel_click")) { return __ref.runUserSub(false, "b4xmainpage","donatepanel_click", __ref);}
 BA.debugLineNum = 79;BA.debugLine="Private Sub donatePanel_Click";
...
try {
		Debug.PushSubsStack("faceView_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("faceview_click")) { return __ref.runUserSub(false, "b4xmainpage","faceview_click", __ref);}
 BA.debugLineNum = 102;BA.debugLine="Private Sub faceView_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="Root.LoadLayout(\"WebView\")";
Debug.ShouldStop(64);
__ref.getField(false,"_root" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("WebView")),__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("instaView_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,107);
if (RapidSub.canDelegate("instaview_click")) { return __ref.runUserSub(false, "b4xmainpage","instaview_click", __ref);}
 BA.debugLineNum = 107;BA.debugLine="Private Sub instaView_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 108;BA.debugLine="Root.LoadLayout(\"WebView\")";
...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 90;BA.debugLine="Root.LoadLayout(\"MainPageLayout\")";
...
try {
		Debug.PushSubsStack("merchPanel_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,84);
if (RapidSub.canDelegate("merchpanel_click")) { return __ref.runUserSub(false, "b4xmainpage","merchpanel_click", __ref);}
 BA.debugLineNum = 84;BA.debugLine="Private Sub merchPanel_Click";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("vTestPanel_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,74);
if (RapidSub.canDelegate("vtestpanel_click")) { return __ref.runUserSub(false, "b4xmainpage","vtestpanel_click", __ref);}
 BA.debugLineNum = 74;BA.debugLine="Private Sub vTestPanel_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 75;BA.debugLine="Root.LoadLayout(\"WebView\")";
Debug.ShouldStop(1024);
__ref.getField(false,"_root" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("WebView")),__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("webBackButton_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,93);
if (RapidSub.canDelegate("webbackbutton_click")) { return __ref.runUserSub(false, "b4xmainpage","webbackbutton_click", __ref);}
 BA.debugLineNum = 93;BA.debugLine="Private Sub webBackButton_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 94;BA.debugLine="xui.MsgboxAsync(\"Go back\", \"Back I Tell You!\")";
Debug.ShouldStop(536870912);
__ref.getField(false,"_xui" /*RemoteObject*/ ).runVoidMethod ("MsgboxAsync",__ref.getField(false, "ba"),(Object)(BA.ObjectToCharSequence("Go back")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Back I Tell You!"))));
...
try {
		Debug.PushSubsStack("ytubeView_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,97);
if (RapidSub.canDelegate("ytubeview_click")) { return __ref.runUserSub(false, "b4xmainpage","ytubeview_click", __ref);}
 BA.debugLineNum = 97;BA.debugLine="Private Sub ytubeView_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 98;BA.debugLine="Root.LoadLayout(\"WebView\")";
Debug.ShouldStop(2);
__ref.getField(false,"_root" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("WebView")),__ref.getField(false, "ba"));
