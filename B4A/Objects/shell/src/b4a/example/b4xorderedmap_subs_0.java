...
try {
		Debug.PushSubsStack("GetDataForSerializator (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("getValues (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("SetDataFromSerializator (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "ba"),__ref,70);
